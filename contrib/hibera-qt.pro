...
RESOURCES += src/qt/hibera.qrc src/qt/hibera_locale.qrc

TRANSLATIONS += src/qt/locale/hibera_bg.ts \
                src/qt/locale/hibera_de.ts \
                src/qt/locale/hibera_en.ts \
                src/qt/locale/hibera_es.ts \
                src/qt/locale/hibera_fi.ts \
                src/qt/locale/hibera_fr.ts \
                src/qt/locale/hibera_it.ts \
                src/qt/locale/hibera_ja.ts \
                src/qt/locale/hibera_pl.ts \
                src/qt/locale/hibera_pt.ts \
                src/qt/locale/hibera_ru.ts \
                src/qt/locale/hibera_sk.ts \
                src/qt/locale/hibera_sv.ts \
                src/qt/locale/hibera_vi.ts \
                src/qt/locale/hibera_zh_CN.ts \
                src/qt/locale/hibera_zh_TW.ts
