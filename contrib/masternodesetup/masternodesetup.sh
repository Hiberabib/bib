...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='hibera.conf'
CONFIGFOLDER='/root/.hibera'
COIN_DAEMON='hiberad'
COIN_CLI='hibera-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/hibera/BIB/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
