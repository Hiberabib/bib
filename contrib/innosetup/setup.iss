...
#define MyAppName "HIBERA Core"
#define MyAppPublisher "2022 HIBERA Core Developers"
#define MyAppURL "https://hibera.net"
#define MyAppExeName "hibera-qt.exe"
#define MyAppExtraData "https://explorer.hibera.net/bootstraps/BIB/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=HIBERASetup
...
[Files]
Source: ".\package\hibera-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\HIBERA\HIBERA-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\HIBERA\HIBERA-Qt,strDataDir|{userappdata}\HIBERA\}');
  Result := True;
end;
