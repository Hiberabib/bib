...
# Create zip file of binaries
	cp hibera/src/hiberad hibera/src/hibera-cli hibera/src/hibera-tx hibera/src/qt/hibera-qt .
	zip BIB-$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip hiberad hibera-cli hibera-tx hibera-qt
	rm -f hiberad hibera-cli hibera-tx hibera-qt
