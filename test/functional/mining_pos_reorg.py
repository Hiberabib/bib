...
from test_framework.test_framework import HiberaTestFramework
...
class ReorgStakeTest(HiberaTestFramework):
    ...
    def check_money_supply(self, expected_bib, expected_zbib):
        ...
        # verify that nodes have the expected BIB and zBIB supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_bib))
            for denom in node['zBIBsupply']:
                assert_equal(node['zBIBsupply'][denom], DecimalAmt(expected_zbib[denom]))
    ...
    def run_test(self):
        ...
        # Check BIB and zBIB supply at the beginning
        # ------------------------------------------
        # zBIB supply: 2 coins for each denomination
        ...
        # BIB supply: block rewards minus burned fees for minting
        ...
        # Verify that BIB and zBIB supplies were properly updated after the spends and reorgs
        self.log.info("Check BIB and zBIB supply...")
