...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (315700, uint256S("0x60eedc0b514a8ad7b7299f5cf451eb715a5192b80099dee5d2927be25ef21b2d"))
    (318156, uint256S("0xc31589f6a6f2ce5e4c46c0e18e49367e0c047c26d3c5d30b29885a75048d15f7"))
    (319999, uint256S("0xcd30c8305519cbd44811baf7bb12e050b5b93c891a9d2c2442ca798dc6fd5340"))
    (320000, uint256S("0x0386340ad80dbe89a0cc936d384220973fec1aa09712b87291b3250cb42821b4"))
    (320141, uint256S("0x055407d6881058b2e2dfc12e22e548b4b5bba1aae7b02cca6548544b4dcdae7d"))
    (320142, uint256S("0x84f3f9e629fe701cd3f079d333fa7f4d41b1adabfdcf5d4dfed8ca7b02a08cd7"))
    (320143, uint256S("0x31167f0f8015362c89cb31a8868b73c2ea301f6bd750b641e95e49b4316b2f01"))
    (320510, uint256S("0x6554f289874e949f82eee8e15d134988ed3321f9111f5f42a28cec2766f251b7"))
    (320987, uint256S("0xf1d3a63c4acaaedcb99b9eb18b9b7553f351c782d81467ec219dab9253241277"))
    (337500, uint256S("0x8f9e44b4f878a3384355a8beab3a58f2466a3e6408d03a405e3282074377982a"))
    (358600, uint256S("0xc161a02069952a3dd08e680ce27ea7c4a6d420f7501ea344ba18b29fbb8ee856"))
    (376480, uint256S("0x1e32068d31acc5f13813188c44a74caf49739453e25aabb0495e66f4556b8d94"))
    (385440, uint256S("0xd0f39a9671a1e7c3fcf497de90771d9a5eaaae1990dad7dbc97559568e8d780e"))
    (410500, uint256S("0x2b00051dbff9cab378b828baefe99044dadad1edcc7890fb1bcba78a842a00f6"))
    (415641, uint256S("0xcd35fb299e2790bf8cf79dd58d9a5ffbcb3f36c2805dc027c3ced676861928b4"))
    (426600, uint256S("0x0145fc070886248a204c27fdb9a71a4f64d01d7bf87a47f6d98e6de3895d8486"))
    (432168, uint256S("0xa580472286d695989317e7030d388546e6c16ac62dd70cf14f74d4c64ba9b265"))
;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1684129815, // * UNIX timestamp of last checkpoint block
    886024,     // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        // spork keys
        consensus.strSporkPubKey = "04d18a19e37a947c57640b2f709f39a319fbcb350139a4ae7c6e9229ca23013d3e99f676fb1a03c8102422ef9e1dd375e333d035e830d2c8c7b0dc6bedeca0d80f";
        ...
        consensus.nTime_EnforceNewSporkKey = 1657623600;   //Tuesday, 12 July 2022 11:00:00 AM GMT
        ...
        vSeeds.push_back(CDNSSeedData("216.128.182.223", "216.128.182.223"));
	    vSeeds.push_back(CDNSSeedData("155.138.137.113", "155.138.137.113"));
        vSeeds.push_back(CDNSSeedData("149.248.59.199", "149.248.59.199"));
        vSeeds.push_back(CDNSSeedData("216.128.179.240", "216.128.179.240"));
        vSeeds.push_back(CDNSSeedData("216.128.179.249", "216.128.179.249"));
	    vSeeds.push_back(CDNSSeedData("149.248.61.97", "149.248.61.97"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // hibera starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.hibera.net"));
	    vSeeds.push_back(CDNSSeedData("tseed1", "tseed1.hibera.net"));
        vSeeds.push_back(CDNSSeedData("tseed2", "tseed2.hibera.net"));
        vSeeds.push_back(CDNSSeedData("tseed3", "tseed3.hibera.net"));
        vSeeds.push_back(CDNSSeedData("tseed4", "tseed4.hibera.net"));
	    vSeeds.push_back(CDNSSeedData("tseed5", "tseed5.hibera.net"));
	    vSeeds.push_back(CDNSSeedData("tseed6", "tseed6.hibera.net"));
	    vSeeds.push_back(CDNSSeedData("tseed7", "tseed7.hibera.net"));
	    vSeeds.push_back(CDNSSeedData("tseed8", "tseed8.hibera.net"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet hibera addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet hibera script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet hibera BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet hibera BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet hibera BIP44 coin type is '1' (All coin's testnet default)
