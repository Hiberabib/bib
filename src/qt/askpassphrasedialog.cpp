...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            HIBERAGUI* window = static_cast<HIBERAGUI*>(parentWidget());
...
{
    HIBERAGUI* gui = static_cast<HIBERAGUI*>(parentWidget());
...
{
    hide();
    static_cast<HIBERAGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("HIBERA will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BIBs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
