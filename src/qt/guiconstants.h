...
/* HIBERA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HIBERA"
#define QAPP_ORG_DOMAIN "hibera.org"
#define QAPP_APP_NAME_DEFAULT "HIBERA-Qt"
#define QAPP_APP_NAME_TESTNET "HIBERA-Qt-testnet"
