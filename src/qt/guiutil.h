...
/** Utility functions used by the HIBERA Qt UI.
 */
namespace GUIUtil
{
...
// Render BIB addresses in monospace font
...
// Parse "hibera:" URI into recipient object, return true on successful parsing
