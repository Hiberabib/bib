...
#include "qt/hibera/sendcustomfeedialog.h"
#include "qt/hibera/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(HIBERAGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &HIBERAGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
