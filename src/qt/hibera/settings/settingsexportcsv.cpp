...
#include "qt/hibera/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(HIBERAGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("HIBERA_tx_csv_export(*.csv)") : tr("HIBERA_addresses_csv_export(*.csv)"),
                                        nullptr);
