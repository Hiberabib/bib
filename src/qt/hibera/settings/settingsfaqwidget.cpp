...
#include "qt/hibera/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/hibera/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(HIBERAGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBIB,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBIB,
    ...
    connect(ui->pushButton_UnspendableBIB, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBIB);});
    ...
    if (parent)
        connect(parent, &HIBERAGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
