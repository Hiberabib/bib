...
#include "qt/hibera/settings/settingsnetworkwidget.h"
#include "qt/hibera/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/hibera/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(HIBERAGUI* _window, QWidget *parent) :
