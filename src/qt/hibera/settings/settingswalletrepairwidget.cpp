...
#include "qt/hibera/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/hibera/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(HIBERAGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to HIBERAGUI::handleRestart()
