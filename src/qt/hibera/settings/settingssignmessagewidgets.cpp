...
#include "qt/hibera/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(HIBERAGUI* _window, QWidget *parent) :
