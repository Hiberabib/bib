...
#include "qt/hibera/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(HIBERAGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &HIBERAGUI::openFAQ);
