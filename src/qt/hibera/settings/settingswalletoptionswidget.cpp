...
#include "qt/hibera/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/hibera/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(HIBERAGUI* _window, QWidget *parent) :
