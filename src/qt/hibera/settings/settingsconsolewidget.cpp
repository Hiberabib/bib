...
#include "qt/hibera/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/hibera/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(HIBERAGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the BIB RPC console.") + "<br>" +
