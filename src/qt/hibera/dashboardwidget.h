...
#include "qt/hibera/furabstractlistitemdelegate.h"
#include "qt/hibera/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/hibera/txviewholder.h"
...
#include "config/hibera-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(HIBERAGUI* _window);
    ~DashboardWidget();
