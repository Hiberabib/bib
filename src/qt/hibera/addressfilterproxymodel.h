...
#ifndef HIBERA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define HIBERA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //HIBERA_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
