...
#include "qt/hibera/forms/ui_topbar.h"
#include "qt/hibera/loadingdialog.h"
#include "qt/hibera/lockunlock.h"
#include "qt/hibera/qtutils.h"
#include "qt/hibera/receivedialog.h"
...
TopBar::TopBar(HIBERAGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
    ...
    ui->pushButtonConf->setButtonText("hibera.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open hibera.conf with default application"));
}
