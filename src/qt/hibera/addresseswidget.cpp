...
#include "qt/hibera/forms/ui_addresseswidget.h"
#include "qt/hibera/addresslabelrow.h"
#include "qt/hibera/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(HIBERAGUI* parent) :
    PWidget(parent),
