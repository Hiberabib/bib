...
#ifndef HIBERA_CORE_NEW_GUI_HIBERAGUI_H
#define HIBERA_CORE_NEW_GUI_HIBERAGUI_H
...
#include "qt/hibera/navmenuwidget.h"
#include "qt/hibera/topbar.h"
#include "qt/hibera/dashboardwidget.h"
#include "qt/hibera/send.h"
#include "qt/hibera/receivewidget.h"
#include "qt/hibera/addresseswidget.h"
#include "qt/hibera/masternodeswidget.h"
#include "qt/hibera/snackbar.h"
#include "qt/hibera/settings/settingswidget.h"
...
/**
  HIBERA GUI main class. This class represents the main window of the HIBERA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class HIBERAGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit HIBERAGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~HIBERAGUI();
...
#endif //HIBERA_CORE_NEW_GUI_HIBERAGUI_H
