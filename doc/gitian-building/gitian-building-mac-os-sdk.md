...
The script [extract-osx-sdk.sh](https://github.com/hibera-project/hibera/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
hibera/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/hibera-project/hibera/blob/master/doc/README_osx.md) for troubleshooting tips.
