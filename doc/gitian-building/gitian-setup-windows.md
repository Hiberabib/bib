...
The build script we'll be using is contained in the HIBERA github repository ([contrib/gitian-build.py](https://github.com/hibera-project/hibera/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the HIBERA repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/HIBERA-Project/HIBERA/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, hibera-detached-sigs, and hibera GitHub repos.
