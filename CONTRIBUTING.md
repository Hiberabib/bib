Contributing to HIBERA Core
============================

The HIBERA Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hibera-project/hibera/blob/master/doc/translation_process.md)
...
The following applies to code changes to the HIBERA Core project, and is not to be
confused with overall HIBERA Network Protocol consensus changes.

Whether a pull request is merged into HIBERA Core rests with the project merge
...
Patches that change HIBERA consensus rules are considerably more involved than
...
Where a patchset proposes to change the HIBERA consensus, it must have been
...
The project leader is the release manager for each HIBERA Core release.
